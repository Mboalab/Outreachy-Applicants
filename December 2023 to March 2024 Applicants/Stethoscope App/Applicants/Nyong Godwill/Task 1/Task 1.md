...
- clone the repository using git clone [Digital-Sthetoscope-app](https://github.com/Mboalab/Improve-a-digital-Sthetoscope-app).  
...
- After getting all the dependencies run flutter run or F5 to install in a local device
   ...
   ![Alt Text](../Task%201/reg.jpeg)![Alt Text](../Task%201/login.jpeg)![Alt Text](../Task%201/splash.jpeg)
